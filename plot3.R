...
#adding variable 1 with black colored line
with(data,lines(Time,as.numeric(as.character(Sub_metering_1)), col="black"))
#adding variable 2 with red colored line
with(data,lines(Time,as.numeric(as.character(Sub_metering_2)),col="red"))
#adding variable 3 with blue colored line
with(data,lines(Time,as.numeric(as.character(Sub_metering_3)),col="blue"))
legend("topright", cex = 0.4, lty=1, col=c("black","red","blue"),
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

#write plot3 to plot3.png
png("plot3.png", width=480, height=480)
plot(data$Time,data$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
with(data,lines(Time,as.numeric(as.character(Sub_metering_1)), col="black"))
with(data,lines(Time,as.numeric(as.character(Sub_metering_2)),col="red"))
with(data,lines(Time,as.numeric(as.character(Sub_metering_3)),col="blue"))
legend("topright", cex = 1.2, lty=1, col=c("black","red","blue"),
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
dev.off()
}